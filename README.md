...
No programming skills are required with the intuitive RoboDK graphical interface. RoboDK has an extensive library of over 500 robot arms among 50 robot manufacturers and works with more than 50 partners to be distributed worldwide.
...
;FOLD Initialise and set default speed BAS (#INITMOV,0)
BAS (#VEL_PTP,100)
BAS (#ACC_PTP,20)
$VEL.CP=0.2
BAS (#TOOL,0)
...
;;ENDFOLD
$ADVANCE = 5
;FOLD ---- Quickly skip BCO ---- ; PTP $AXIS_ACT
;ENDFOLD
;FOLD ---- GO HOME ----
...
; BASE_DATA[2] = {FRAME: X -206.148,Y 1000.000,Z 7.718,A 0.000,B 0.000,C 0.000} $BASE = {FRAME: X -206.148,Y 1000.000,Z 7.718,A 0.000,B 0.000,C 0.000}
; $BASE = BASE_DATA[2]
; --------------------------
; ---- Setting tool (TCP) ----
...
LIN {X 1235.570,Y -1105.760,Z 604.600,A -180.000,B 16.211,C 180.000,E1 0.00000} LIN {X 1345.910,Y -1105.760,Z 606.688,A -180.000,B 16.211,C 180.000,E1 0.00000} PTP {A1 -4.77441,A2 -53.72510,A3 37.63500,A4 3.97689,A5 60.03810,A6 -5.29643,E1 0.00000}
